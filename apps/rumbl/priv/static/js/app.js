...
var Video = {
  ...
  onReady: function onReady(videoId, socket) {
    ...
    vidChannel.join().receive('ok', function (resp) {
      ...
      _this2.scheduleMessage(msgContainer, resp.annotations);
  ...
  scheduleMessage: function scheduleMessage(msgContainer, annotations) {
    var _this3 = this;

    setTimeout(function () {
      var ctime = _player2.default.getCurrentTime();
      var remaining = _this3.renderAtTime(annotations, ctime, msgContainer);
      _this3.scheduleMessage(msgContainer, remaining);
    }, 1000);
  },
